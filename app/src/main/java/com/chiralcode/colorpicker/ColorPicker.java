...
//        Log.i("rgb", "createColorWheelBitmap");
...
//        Log.i("rgb", "########");
//        Log.i("rgb", String.valueOf(Color.red(color)));
//        Log.i("rgb", String.valueOf(Color.green(color)));
//        Log.i("rgb", String.valueOf(Color.blue(color)));
//        Log.i("rgb", "onTouch");
//        Log.i("rgb", "########");
